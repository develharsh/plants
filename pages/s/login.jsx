...
function Login() {
  ...
  return (
    <>
      <div className="flex flex-wrap justify-evenly s_login_main_div">
        <div>
          <img className="s_login_tile" src="/loginBg.png" alt="" />
        </div>
        <div className="shadow-2xl rounded p-7 s_login_input_div">
