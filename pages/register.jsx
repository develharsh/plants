...
function Register() {
  ...
  return (
    <>
      <div className="flex flex-wrap justify-evenly register_main_div">
        <div>
          <img className="register_tile" src="signupBg.png" alt="" />
        </div>
        <div className="shadow-2xl rounded p-7 register_input_div">
